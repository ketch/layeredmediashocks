...
#------------------------------
    ...
    probdata.add_param('K_B',    3.0,   'bulk modulus in B-layers')
    ...
    probdata.add_param('x0char',   50., 'x to start chars') 
    probdata.add_param('t0char',   30., 'time to start chars') 
    probdata.add_param('dtchar',   1., 'increment between new chars') 
