...
!       - Add smoothly varying media as run-time option
      ...
      dimension dintloc(300)
      common /commat/ dKA, dKB, rhoA, rhoB

      open(unit=19,file='randint.data',status='old',form='formatted')
      do i=1,300
         read(19,*) dintdev
         !dintloc(i) = 0.5d0+dintdev
         dintloc(i) = dintdev
         enddo
      write(6,*) 'Using randint.data...'
